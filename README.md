...
When trying to install the SAP system with ASE database on Ubuntu 21.04 (or e.g. on Leap 15.4) the installation run hangs. This can be solved be adding the following parameter in Mid-air. 
