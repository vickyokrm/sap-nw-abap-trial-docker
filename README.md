...
1. Now start the installation of SAP NW ABAP 7.52 Trial
    ...
    - Or the standard way, the argument (k) is optional helps to skip **vm.max_map_count** parameter checks
...
1. When trying to install the SAP system with ASE database on Ubuntu 21.04 (or e.g. on Leap 15.4) the installation run hangs. This can be solved be adding the following parameter in Mid-air. 
Refer this [blog](https://community.sap.com/t5/technology-blog-posts-by-members/adjusting-installer-script-for-sap-netweaver-dev-edition-for-distros-with/ba-p/13492318)
  ```sh
